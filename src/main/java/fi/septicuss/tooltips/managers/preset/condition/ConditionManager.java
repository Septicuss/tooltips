package fi.septicuss.tooltips.managers.preset.condition;

import java.util.HashMap;
import java.util.Map;

import fi.septicuss.tooltips.api.TooltipsAPI;
import fi.septicuss.tooltips.managers.preset.condition.parser.ArgumentParser;
import fi.septicuss.tooltips.managers.preset.condition.parser.CompositeConditionParser;
import fi.septicuss.tooltips.managers.preset.condition.parser.ConditionParser;
import fi.septicuss.tooltips.managers.preset.condition.parser.StatementParser;
